              ...
              <div>
                ...
                <div className="flex flex-wrap gap-3">
                  {[7, 8, 9, 10, 11, 12].map(size => {
                    // Convert size to number to ensure proper comparison
                    const sizeNum = Number(size);
                    const isSelected = editForm.sizes.some(s => Number(s) === sizeNum);
                    ...
                    return (
                      <button
                        ...
                        onClick={() => setEditForm(prev => ({
                          ...prev,
                          sizes: isSelected
                            ? prev.sizes.filter(s => Number(s) !== sizeNum)
                            : sortSizes([...prev.sizes, sizeNum])
                        }))}
